...
export const videoStatsSnapshot = pgTable(
...
export const trendSignal = pgTable(
  "trend_signal",
  {
    id: serial("id").primaryKey(),
    videoId: integer("video_id")
...
export const storyClusterVideo = pgTable(
  "story_cluster_video",
  {
    clusterId: integer("cluster_id")
      .notNull()
      .references(() => storyCluster.id),
    videoId: integer("video_id")
      .notNull()
      .references(() => trackedVideo.id),
  },
